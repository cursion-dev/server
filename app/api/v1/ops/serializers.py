...
class ScanSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        'time_completed', 'html', 'logs', 'lighthouse', 'security',
...
class SmallScanSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        'time_completed', 'lighthouse', 'security', 'configs', 'tags', 'score',
        ]
...
class TestSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        'lighthouse_delta', 'security_delta', 'images_delta', 'type', 'threshold',
...
class SmallTestSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        'security_delta', 'tags', 'component_scores', 'threshold', 'status',
        ]
